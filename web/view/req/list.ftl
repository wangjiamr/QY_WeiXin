...
<div class="view">
    ...
    <header class="header clearfix">
        <div class="TopL">
            <#--<span class="BtnIcon Calleft"></span>-->
        </div>
        <div class="TopM aligncenter">
            <span class="block font16" id="menuDown"><span>进行中</span><em class="BtnIcon Icon-toggle"></em></span>
        </div>
        <div class="TopR" id="Search">
            <span class="BtnIcon TopSer"></span>
        </div>
    </header>
    <!--header over-->
    <!--审核状态选择 弹出begin-->
    <div class="TopDown" id="menuRemind">
        <div class="TopDownIn">
            <ul>
                <li dir="ing">
                    <i class="BtnIcon Icon-wait"></i><span>进行中</span><em class="prompt" style="display: none;">0</em>
                </li>
                <li dir="history">
                    <i class="BtnIcon Icon-history"></i><span>已完成</span><em class="prompt" style="display:none;">0</em>
                </li>
                <li dir="confirm">
                    <i class="BtnIcon Icon-sure"></i><span>未确认</span><em class="prompt" style="display:none;">0</em>
                </li>
            </ul>
        </div>
    </div>
